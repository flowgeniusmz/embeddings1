...
def set_title(varTitle, varSubtitle):
        st.markdown(f"""<span style="font-weight: bold; font-size: 2em; color:#00b088;">{varTitle} </span> <span style="font-weight: bold; color:#0096D7; font-size:1.3em;">{varSubtitle}</span>""", unsafe_allow_html=True)
        st.divider()
